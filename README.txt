...
It allows you to write your ViewModel classes much cleaner because you don't need to write UI notification code on each property 
(it internally uses awesome PostSharp library to do this kind of work for you under the covers).
It also has:
 ...
 - baked-in IoC and validation support (StructureMap and FluentValidation are used by default, DataAnnotations can be used easily, 
planned support for NInject/Autofac).
Configuration API will definitely come out in later releases. It uses Convention over Configuration approach, so it'll allow you 
to override pretty much everything that you don't like.
Library includes simple WPF example app.
...
I think first 0.5.0.something release will come in first half of May 2012.
